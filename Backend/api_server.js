...
// require('./config/draught_services_employees.js')(app);
// require('./config/draught_services_cycles.js')(app);
// require('./config/draught_services_products.js')(app);
// require('./config/draught_services_accounts.js')(app);
require('./config/board_trivias.js')(app);
require('./config/high_scores.js')(app);
